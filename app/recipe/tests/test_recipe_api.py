...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        """ Test auth is requred to call API """
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_link = 'hhtps://example.com/recipe.pdf'
    ...
    def test_update_recipe_assign_tag(self):
        """ Tag assigning an existing tag when updating a recipe """
    ...
    def test_create_recipe_w_new_ingredients(self):
        """ Test create a recipe with new ingredient """
        payload = {
    ...
    def test_create_recipe_w_existing_ingredient(self):
